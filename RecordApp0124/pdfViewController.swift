...
>>>>>>> e72933d015b2a66dff16df23379df5412c797e77
    ...
    func makeDefaultFile(){
        ...
        let documentsDirectory3 = documentsDirectory2.appendingPathComponent("FolderList").appendingPathComponent((self.delegate?.eachFolderName)!)
    ...
    func getDocumentsDirectory() -> URL {
        ...
        let documentsDirectory = paths[0].appendingPathComponent("FolderList").appendingPathComponent((self.delegate?.eachFolderName)!)
            .appendingPathComponent((self.delegate?.eachFolderName)! + "_audio").appendingPathComponent((self.delegate?.eachPDFName)!)
    ...
    @objc func recordFinish(_ sender: UIButton){
        ...
        let okAction = UIAlertAction(title: "OK", style: .default){
            ...
            let documentsDirectory2 = documentsDirectory.appendingPathComponent("FolderList").appendingPathComponent((self.delegate?.eachFolderName)!)
                .appendingPathComponent((self.delegate?.eachFolderName)! + "_audio").appendingPathComponent((self.delegate?.eachPDFName)!)
