...
class FolderViewController: UIViewController  , UITableViewDataSource , UITableViewDelegate{
    ...
    @IBAction func folderPlusBtn(_ sender: UIButton) {
        ...
        let okAction = UIAlertAction(title: "OK", style: .default) { action -> Void in
            ...
            let managePDF = documentsDirectory.appendingPathComponent(folderName).appendingPathComponent(folderName + "_pdf")
            let manageAUDIO = documentsDirectory.appendingPathComponent(folderName).appendingPathComponent(folderName + "_audio")
            ...
            do {
                try fileManager.createDirectory(atPath: managePDF.path, withIntermediateDirectories: false, attributes: nil)
            } catch {
                
            }
            
            do {
                try fileManager.createDirectory(atPath: manageAUDIO.path, withIntermediateDirectories: false, attributes: nil)
            } catch {
